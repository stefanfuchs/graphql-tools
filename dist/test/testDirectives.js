...
describe('@directives', function () {
    ...
    it('can be implemented with SchemaDirectiveVisitor', function () {
        var visited = new Set;
        var schema = makeExecutableSchema_1.makeExecutableSchema({ typeDefs: typeDefs });
        var visitCount = 0;
    ...
    it('can also handle declared arguments', function () {
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({ typeDefs: schemaText });
        var context = {
            objectCount: 0,
            fieldCount: 0,
        };
    ...
    it('allows multiple directives when first replaces type (issue #851)', function () {
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                upper: /** @class */ (function (_super) {
                    ...
                    class_21.prototype.visitFieldDefinition = function (field) {
                        var _a = field.resolve, resolve = _a === void 0 ? graphql_1.defaultFieldResolver : _a;
                        var newField = __assign({}, field);
                        newField.resolve = function () {
                            var args = [];
                            for (var _i = 0; _i < arguments.length; _i++) {
                                args[_i] = arguments[_i];
                            }
                ...
                reverse: /** @class */ (function (_super) {
                    __extends(class_22, _super);
                    function class_22() {
                        return _super !== null && _super.apply(this, arguments) || this;
                    }
                    class_22.prototype.visitFieldDefinition = function (field) {
                        var _a = field.resolve, resolve = _a === void 0 ? graphql_1.defaultFieldResolver : _a;
                        field.resolve = function () {
                            var args = [];
                            for (var _i = 0; _i < arguments.length; _i++) {
