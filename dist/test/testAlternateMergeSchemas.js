...
describe('interface resolver inheritance', function () {
    var testSchemaWithInterfaceResolvers = "\n    interface Node {\n      id: ID!\n    }\n    type User implements Node {\n      id: ID!\n      name: String!\n    }\n    type Query {\n      user: User!\n    }\n    schema {\n      query: Query\n    }\n  ";
    var user = { _id: 1, name: 'Ada', type: 'User' };
    var resolvers = {
        Node: {
    ...
    it('copies resolvers from interface', function () { return __awaiter(_this, void 0, void 0, function () {
        var mergedSchema, query, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mergedSchema = mergeSchemas_1.default({
                        schemas: [
                            ...
                            testingSchemas_1.propertySchema,
    ...
    it('does not copy resolvers from interface when flag is false', function () { return __awaiter(_this, void 0, void 0, function () {
        var mergedSchema, query, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    response = _a.sent();
                    chai_1.expect(response.errors.length).to.equal(1);
                    chai_1.expect(response.errors[0].message).to.equal('Cannot return null for ' +
                        'non-nullable field User.id.');
                    chai_1.expect(response.errors[0].path).to.deep.equal(['user', 'id']);
                    return [2 /*return*/];
            }
        });
    }); });
    it('does not copy resolvers from interface when flag is not provided', function () { return __awaiter(_this, void 0, void 0, function () {
        var mergedSchema, query, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
