...
exports.propertySchema = makeExecutableSchema_1.makeExecutableSchema({
    typeDefs: propertyAddressTypeDefs,
    resolvers: propertyResolvers,
});
exports.productSchema = makeExecutableSchema_1.makeExecutableSchema({
    typeDefs: productTypeDefs,
    resolvers: productResolvers,
});
exports.bookingSchema = makeExecutableSchema_1.makeExecutableSchema({
    typeDefs: bookingAddressTypeDefs,
    resolvers: bookingResolvers,
});
exports.subscriptionSchema = makeExecutableSchema_1.makeExecutableSchema({
