...
describe('generating schema from shorthand', function () {
    it('throws an error if no schema is provided', function () {
        chai_1.expect(function () { return makeExecutableSchema_1.makeExecutableSchema(); }).to.throw('undefined');
    });
    it('throws an error if typeDefinitionNodes are not provided', function () {
        chai_1.expect(function () {
            return makeExecutableSchema_1.makeExecutableSchema({ typeDefs: undefined, resolvers: {} });
        }).to.throw('Must provide typeDefs');
    });
    it('throws an error if no resolveFunctions are provided', function () {
        chai_1.expect(function () {
            return makeExecutableSchema_1.makeExecutableSchema({ typeDefs: 'blah', resolvers: {} });
    ...
    it('throws an error if typeDefinitionNodes is neither string nor array nor schema AST', function () {
        chai_1.expect(function () {
            return makeExecutableSchema_1.makeExecutableSchema({ typeDefs: {}, resolvers: {} });
    ...
    it('throws an error if typeDefinitionNode array contains not only functions and strings', function () {
        chai_1.expect(function () {
            return makeExecutableSchema_1.makeExecutableSchema({ typeDefs: [17], resolvers: {} });
    ...
    it('can concatenateTypeDefs created by a function inside a closure', function () {
        ...
        var result = makeExecutableSchema_1.concatenateTypeDefs([
    ...
    it('shows a warning if a field has arguments but no resolve func', function () {
        ...
        expectWarning(function () {
            makeExecutableSchema_1.makeExecutableSchema({
                typeDefs: short,
                resolvers: rf,
    ...
    it('does not throw an error if `resolverValidationOptions.requireResolversForArgs` is false', function () {
        ...
        var rf = { Query: {} };
        // tslint:disable-next-line: max-line-length
        chai_1.assert.doesNotThrow(makeExecutableSchema_1.makeExecutableSchema.bind(null, { typeDefs: short, resolvers: rf }), makeExecutableSchema_1.SchemaError);
    });
    ...
    it('allows non-scalar field to use default resolve func if `resolverValidationOptions.requireResolversForNonScalar` = false', function () {
        ...
        var rf = {};
        // tslint:disable-next-line: max-line-length
        chai_1.assert.doesNotThrow(makeExecutableSchema_1.makeExecutableSchema.bind(null, {
            typeDefs: short,
            resolvers: rf,
            resolverValidationOptions: { requireResolversForNonScalar: false },
        }), makeExecutableSchema_1.SchemaError);
    });
    it('throws if resolver defined for non-object/interface type', function () {
        ...
        chai_1.expect(function () {
            return makeExecutableSchema_1.makeExecutableSchema({ typeDefs: short, resolvers: rf });
    ...
    it('throws if resolver value is invalid', function () {
        var short = "\n      type Person {\n        name: String\n        age: Int\n      }\n      type RootQuery {\n        search(name: String): [Person]\n      }\n      schema {\n        query: RootQuery\n      }\n    ";
        var rf = {
        ...
        chai_1.expect(function () {
            return makeExecutableSchema_1.makeExecutableSchema({ typeDefs: short, resolvers: rf });
        }).to.throw("\"Searchable\" defined in resolvers, but has invalid value \"undefined\". A resolver's value " +
    ...
    it('does not let you define resolver field for enum values not present in schema', function () {
        var short = "\n      enum Color {\n        RED\n      }\n\n      enum NumericEnum {\n        TEST\n      }\n\n      schema {\n        query: Query\n      }\n\n      type Query {\n        color: Color\n        numericEnum: NumericEnum\n      }\n    ";
        var rf = {
            Color: {
                RED: '#EA3232',
...
describe('Add error logging to schema', function () {
    it('throws an error if no logger is provided', function () {
        chai_1.assert.throw(function () { return makeExecutableSchema_1.addErrorLoggingToSchema({}); }, 'Must provide a logger');
    });
    it('throws an error if logger.log is not a function', function () {
        chai_1.assert.throw(function () { return makeExecutableSchema_1.addErrorLoggingToSchema({}, { log: '1' }); }, 'Logger.log must be a function');
    });
});
describe('Attaching connectors to schema', function () {
    describe('Schema level resolve function', function () {
        it('actually runs', function () {
            ...
            makeExecutableSchema_1.addSchemaLevelResolveFunction(jsSchema, rootResolver);
            var query = "{\n        species(name: \"strix\")\n      }";
    ...
    it('actually attaches the connectors', function () {
        ...
        makeExecutableSchema_1.attachConnectorsToContext(jsSchema, testConnectors);
        var query = "{\n      useTestConnector\n    }";
        var expected = {
    ...
    it('throws error if trying to attach connectors twice', function () {
        ...
        return chai_1.expect(function () {
            return makeExecutableSchema_1.attachConnectorsToContext(jsSchema, testConnectors);
    ...
    it('throws error during execution if context is not an object', function () {
        ...
        makeExecutableSchema_1.attachConnectorsToContext(jsSchema, { someConnector: {} });
        var query = "{\n      useTestConnector\n    }";
    ...
    it('throws error if trying to attach non-functional connectors', function () {
        ...
        makeExecutableSchema_1.attachConnectorsToContext(jsSchema, { testString: 'a' });
        var query = "{\n      species(name: \"strix\")\n      stuff\n      useTestConnector\n    }";
    ...
    it('throws error if no schema is passed', function () {
        chai_1.expect(function () { return makeExecutableSchema_1.attachConnectorsToContext(); }).to.throw('schema must be an instance of GraphQLSchema. ' +
    ...
    it('throws error if connectors argument is an array', function () {
        ...
        chai_1.expect(function () { return makeExecutableSchema_1.attachConnectorsToContext(jsSchema, [1]); }).to.throw('Expected connectors to be of type object, got Array');
    });
    it('throws error if connectors argument is an empty object', function () {
        ...
        return chai_1.expect(function () { return makeExecutableSchema_1.attachConnectorsToContext(jsSchema, {}); }).to.throw('Expected connectors to not be an empty object');
    });
    it('throws error if connectors argument is not an object', function () {
        ...
        return chai_1.expect(function () {
            return makeExecutableSchema_1.attachConnectorsToContext(jsSchema, 'a');
...
describe('chainResolvers', function () {
    it('can chain two resolvers', function () {
        ...
        var rChained = makeExecutableSchema_1.chainResolvers([r1, r2]);
    ...
    it('uses default resolver when a resolver is undefined', function () {
        ...
        var rChained = makeExecutableSchema_1.chainResolvers([r1, undefined, r3]);
...
describe('attachDirectiveResolvers on field', function () {
    ...
    it('throws error if directiveResolvers argument is an array', function () {
        ...
        chai_1.expect(function () { return makeExecutableSchema_1.attachDirectiveResolvers(jsSchema, [1]); }).to.throw('Expected directiveResolvers to be of type object, got Array');
    });
    it('throws error if directiveResolvers argument is not an object', function () {
        ...
        return chai_1.expect(function () {
            return makeExecutableSchema_1.attachDirectiveResolvers(jsSchema, 'a');
